        ...
        datasets: [
          {
            ...
            data: [
              183, 163, 176, 172, 166, 161, 164, 159, 172, 173, 184, 163, 99,
              173, 183, 167, 160, 183, 163, 176, 172, 166, 173, 188, 175,
            ],
            barPercentage: 0.9,
...
utils.$document.ready(function () {
  ...
  if (columns.length) {
    ...
    sortable.on(Events.DRAG_STOP, function (e) {
      ...
      var from = e.sourceContainer.id.split("addCards")[1];
      var to = $itemContainer[0].id.split("addCards")[1];
      var item = e.data.source.dataset.block;
  ...
  var moveNavContent = function moveNavContent(width) {
    if (width < navbarTopBreakpoint) {
      ...
      if (navbarTopContent) {
        ...
        navbarTopContent =
          "<div data-move-container>" + divider + navbarTopContent + "</div>";
...
utils.$document.ready(function () {
  ...
  $searchAreas.each(function (index, value) {
    ...
    btnDropdownClose &&
      btnDropdownClose.addEventListener(Events.CLICK, function () {
  ...
  },
  {
    ...
    schedules: [
      ...
      },
      {
        title: "Lunch",
        start:
          currentYear + "-" + currentMonth + "-" + currentDay + " 14:00:00",
      ...
      },
      {
        title: "Contest",
        start:
          currentYear + "-" + currentMonth + "-" + currentDay + " 16:00:00",
      ...
      },
      {
        title: "Dinner",
        start:
          currentYear + "-" + currentMonth + "-" + currentDay + " 22:00:00",
...
utils.$document.ready(function () {
  ...
  if (calendarEl) {
    ...
    document
      ...
      .addEventListener(Events.SUBMIT, function (e) {
        e.preventDefault();
...
var getStackIcon = function getStackIcon(icon, transform) {
  return (
    ...
    icon +
    ' fa-stack-1x text-primary" data-fa-transform=' +
    transform +
    "></i>\n      </span>\n    "
  );
};
...
var getTemplate = function getTemplate(info) {
  return (
    ...
    '\n      <div class="media-body">\n          <h6>Date and Time</h6>\n          <p class="mb-1">\n            ' +
    (window.dayjs &&
      window.dayjs(info.event.start).format("dddd, MMMM D, YYYY, h:mm A")) +
    " \n            " +
    (info.event.end
      ? "\u2013 <br/>" +
        (window.dayjs &&
